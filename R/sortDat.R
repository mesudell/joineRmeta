...
#'     terms expanded out
#' @param survdat survival dataset with factor variables and interaction
#'     terms expanded out
#' @param longdat2 longitudinal dataset with original variables
#' @param survdat2 survival dataset with original variables
#'
#' @return a list containing four ordered versions of the inputted datasets.
#'     In the output \code{long.s} is the the ordered version of \code{longdat},
#'     \code{surv.s} is the ordered version of \code{survdat}, \code{long.s2} is
#'     the ordered version of longdat2, and \code{surv.s2} is the ordered
#'     version of survdat2.
#'
#' @keywords internal
