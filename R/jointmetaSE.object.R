...
#'     \code{jointmeta1SE} representing the results of bootstrapping a fit from
#'     the \code{jointmeta1} function.  Objects of this class have methods for
#'     the \code{\link{print}} and \code{\link{vcov}}
#'     functions.
#'
